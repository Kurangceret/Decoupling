...
Animations = {
  {
      ...
      {
        name = "Recovery_Heavy_Attack_Left",
				textureLocation = TextureDir .. "human_side_swing_sword.png",
				origLists = {
          {
						frame = {frameSizeHeavyAttackSide[1] * 0, frameSizeHeavyAttackSide[2] * 7, 0, 0},
      ...
      
      {
        name = "Heavy_Attack_Down_1",
					...
					},
          {
				...
				wholeFrameSize = {frameSizeHeavyAttackDown[1], frameSizeHeavyAttackDown[2]},
				wholeDuration = 0.6,
				flipX = false,
				endToStart = false,
				isRepeating = false,
      ...
      },
      {
        name = "Heavy_Attack_Down_3",
				...
				origLists = {
          {
					...
					{
						frame = {frameSizeHeavyAttackDown[1] * 2, frameSizeHeavyAttackDown[2] * 7, 0, 0},
						duration = animAttackHeavy3Dur
					},
          {
						frame = {frameSizeHeavyAttackDown[1] * 3, frameSizeHeavyAttackDown[2] * 7, 0, 0},
						duration = animAttackHeavy3Dur
					},
          {
						frame = {frameSizeHeavyAttackDown[1] * 0, frameSizeHeavyAttackDown[2] * 8, 0, 0},
						duration = animAttackHeavy3Dur
					}
				},
				wholeFrameSize = {frameSizeHeavyAttackDown[1], frameSizeHeavyAttackDown[2]},
      ...
      {
        name = "Recovery_Heavy_Attack_Down",
				textureLocation = TextureDir .. "human_front_attack.png",
				origLists = {
          {
						frame = {frameSizeHeavyAttackDown[1] * 1, frameSizeHeavyAttackDown[2] * 8, 0, 0},
						duration = animRecoveryDur
					},
					{
						frame = {frameSizeHeavyAttackDown[1] * 2, frameSizeHeavyAttackDown[2] * 8, 0, 0},
						duration = animRecoveryDur
					},
					{
						frame = {frameSizeHeavyAttackDown[1] * 3, frameSizeHeavyAttackDown[2] * 8, 0, 0},
						duration = animRecoveryDur
					},
					{
						frame = {frameSizeHeavyAttackDown[1] * 0, frameSizeHeavyAttackDown[2] * 9, 0, 0},
						duration = animRecoveryDur
					},
					{
						frame = {frameSizeHeavyAttackDown[1] * 1, frameSizeHeavyAttackDown[2] * 9, 0, 0},
						duration = animRecoveryDur
					},
					{
						frame = {frameSizeHeavyAttackDown[1] * 2, frameSizeHeavyAttackDown[2] * 9, 0, 0},
						duration = animRecoveryDur
					},
					{
						frame = {frameSizeHeavyAttackDown[1] * 3, frameSizeHeavyAttackDown[2] * 9, 0, 0},
						duration = animRecoveryDur
					},
					{
						frame = {frameSizeHeavyAttackDown[1] * 0, frameSizeHeavyAttackDown[2] * 10, 0, 0},
						duration = animRecoveryDur
					}
				},
				wholeFrameSize = {frameSizeHeavyAttackDown[1], frameSizeHeavyAttackDown[2]},
      ...
      ------------------------
     {
        name = "Heavy_Attack_Up_1",
					...
					},
          {
				...
				wholeFrameSize = {frameSizeHeavyAttackUp[1], frameSizeHeavyAttackUp[2]},
				wholeDuration = 0.6,
				flipX = false,
				endToStart = false,
				isRepeating = false,
      ...
      },
      {
        name = "Heavy_Attack_Up_3",
				...
				origLists = {
          {
					...
					{
						frame = {frameSizeHeavyAttackUp[1] * 2, frameSizeHeavyAttackUp[2] * 7, 0, 0},
						duration = animAttackHeavy3Dur
					},
          {
						frame = {frameSizeHeavyAttackUp[1] * 3, frameSizeHeavyAttackUp[2] * 7, 0, 0},
						duration = animAttackHeavy3Dur
					},
          {
						frame = {frameSizeHeavyAttackUp[1] * 0, frameSizeHeavyAttackUp[2] * 8, 0, 0},
						duration = animAttackHeavy3Dur
					}
				},
				wholeFrameSize = {frameSizeHeavyAttackUp[1], frameSizeHeavyAttackUp[2]},
      ...
      {
        name = "Recovery_Heavy_Attack_Up",
				textureLocation = TextureDir .. "human_back_attack.png",
				origLists = {
          {
						frame = {frameSizeHeavyAttackUp[1] * 1, frameSizeHeavyAttackUp[2] * 8, 0, 0},
						duration = animRecoveryDur
					},
					{
						frame = {frameSizeHeavyAttackUp[1] * 2, frameSizeHeavyAttackUp[2] * 8, 0, 0},
						duration = animRecoveryDur
					},
					{
						frame = {frameSizeHeavyAttackUp[1] * 3, frameSizeHeavyAttackUp[2] * 8, 0, 0},
						duration = animRecoveryDur
					},
					{
						frame = {frameSizeHeavyAttackUp[1] * 0, frameSizeHeavyAttackUp[2] * 9, 0, 0},
						duration =animRecoveryDur
					},
					{
						frame = {frameSizeHeavyAttackUp[1] * 1, frameSizeHeavyAttackUp[2] * 9, 0, 0},
						duration = animRecoveryDur
					},
					{
						frame = {frameSizeHeavyAttackUp[1] * 2, frameSizeHeavyAttackUp[2] * 9, 0, 0},
						duration = animRecoveryDur
					},
					{
						frame = {frameSizeHeavyAttackUp[1] * 3, frameSizeHeavyAttackUp[2] * 9, 0, 0},
						duration = animRecoveryDur
					},
					{
						frame = {frameSizeHeavyAttackUp[1] * 0, frameSizeHeavyAttackUp[2] * 10, 0, 0},
						duration = animRecoveryDur
					}
				},
				wholeFrameSize = {frameSizeHeavyAttackUp[1], frameSizeHeavyAttackUp[2]},
